...
var (
	...
	FreedomBlockReward            = big.NewInt(0) // Block reward in wei for successfully mining a block upward from Freedom
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if config.IsFreedom(header.Number) {
		blockReward = FreedomBlockReward
	}
