...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EIP150Hash:                    common.HexToHash("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3"),
...
func (c *ChainConfig) Description() string {
	...
	banner += fmt.Sprintf(" - Freedom:                     #%-8v (https://github.com/ethereum/execution-specs/blob/master/network-upgrades/mainnet-upgrades/freedom.md)\n", c.FreedomBlock)
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "freedomBlock", block: c.FreedomBlock},
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, headNumber *big.Int, headTimestamp uint64) *ConfigCompatError {
	...
	if isForkBlockIncompatible(c.FreedomBlock, newcfg.FreedomBlock, headNumber) {
		return newBlockCompatError("Freedom fork block", c.FreedomBlock, newcfg.FreedomBlock)
	}
...
type Rules struct {
	...
	IsBerlin, IsLondon, IsFreedom                           bool
