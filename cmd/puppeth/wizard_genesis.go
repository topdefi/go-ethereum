...
func (w *wizard) manageGenesis() {
	...
	case "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Freedom come into effect? (default = %v)\n", w.conf.Genesis.Config.FreedomBlock)
		w.conf.Genesis.Config.FreedomBlock = w.readDefaultBigInt(w.conf.Genesis.Config.FreedomBlock)
